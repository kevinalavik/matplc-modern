...
*************************************************************************/
inline int read_output_bits(int slave,
                            int start_addr,
                            int count,
                            int *dest,
                            int dest_size,
...
#define read_coil_status(p1,p2,p3,p4,p5,p6,p7,p8) \
        read_output_bits(p1,p2,p3,p4,p5,p6,p7,p8)
...
inline int read_input_bits(int slave,
                           int start_addr,
                           int count,
                           int *dest,
                           int dest_size,
...
#define read_input_status(p1,p2,p3,p4,p5,p6,p7,p8) \
        read_input_bits  (p1,p2,p3,p4,p5,p6,p7,p8)
...
inline int read_output_words(int slave,
                             int start_addr,
                             int count,
                             int *dest,
                             int dest_size,
...
#define read_holding_registers(p1,p2,p3,p4,p5,p6,p7,p8) \
        read_output_words     (p1,p2,p3,p4,p5,p6,p7,p8)
...
inline int read_input_words(int slave,
                            int start_addr,
                            int count,
                            int *dest,
                            int dest_size,
...
#define read_input_registers(p1,p2,p3,p4,p5,p6,p7,p8) \
        read_input_words    (p1,p2,p3,p4,p5,p6,p7,p8)
...
inline int write_output_bit(int slave,
                            int addr,
                            int state,
                            int fd,
                            int send_retries,
...
#define force_single_coil(p1,p2,p3,p4,p5,p6) \
        write_output_bit (p1,p2,p3,p4,p5,p6)
...
inline int write_output_word(int slave,
                             int reg_addr,
                             int value,
                             int fd,
                             int send_retries,
...
#define preset_single_register(p1,p2,p3,p4,p5,p6) \
        write_output_word     (p1,p2,p3,p4,p5,p6)
...
int write_output_bits(int slave,
                      int start_addr,
                      int coil_count,
                      int *data,
                      int fd,
...
#define set_multiple_coils(p1,p2,p3,p4,p5,p6,p7) \
        write_output_bits (p1,p2,p3,p4,p5,p6,p7)
...
int write_output_words( int slave, int start_addr,
                        int reg_count,
                        int *data,
                        int fd,
                        int send_retries,
...
#define preset_multiple_registers(p1,p2,p3,p4,p5,p6) \
        write_output_words       (p1,p2,p3,p4,p5,p6)
